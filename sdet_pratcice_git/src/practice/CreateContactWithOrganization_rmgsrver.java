package practice;
	...
	public class CreateContactWithOrganization_rmgsrver {
		public static void main(String[] args) {
             //we have to declare variables first
            ...
            //first we have to maximize the browser
			driver.manage().window().maximize();
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			//we have to use actions class before opening the website 
			Actions act=new Actions(driver);
			
			driver.get("http://rmgtestingserver:8888/index.php?module=Accounts&action=EditView&return_action=DetailView&parenttab=Marketing");
